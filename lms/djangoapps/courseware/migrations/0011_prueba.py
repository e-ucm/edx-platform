...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'XModuleMinigame'
        db.create_table('courseware_xmoduleminigame', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tagline', self.gf('django.db.models.fields.TextField')(default='null')),
        ))
        db.send_create_signal('courseware', ['XModuleMinigame'])


    def backwards(self, orm):
        # Deleting model 'XModuleMinigame'
        db.delete_table('courseware_xmoduleminigame')
    ...
    models = {
        ...
        'courseware.xmoduleminigame': {
            'Meta': {'object_name': 'XModuleMinigame'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tagline': ('django.db.models.fields.TextField', [], {'default': "'null'"})
        },
