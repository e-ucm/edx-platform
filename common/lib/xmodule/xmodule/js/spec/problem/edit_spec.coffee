describe 'MarkdownEditingDescriptor', ->
  ...
  describe 'insertExplanation', ->
   ...
   describe 'insertEadventure', ->
    it 'inserts the template if selection is empty', ->
      revisedSelection = MarkdownEditingDescriptor.insertEadventure('')
      expect(revisedSelection).toEqual(MarkdownEditingDescriptor.eadventureTemplate)
    it 'wraps existing text', ->
      revisedSelection = MarkdownEditingDescriptor.insertEadventure('my text')
      expect(revisedSelection).toEqual('[eadventure]\nmy text\n[eadventure]')
